  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus:border-primary focus:ring-2 focus:ring-primary/20 hover:border-gray-400",
        "aria-invalid:ring-destructive/30 aria-invalid:border-destructive aria-invalid:focus:ring-destructive/20",
        className
      )}
      {...props}
    />
